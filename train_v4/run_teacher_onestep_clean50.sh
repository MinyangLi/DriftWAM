...
# Without an explicitly gated resume, initialize both the online student and
# EMA target from the LingBot-VA teacher checkpoint.
export STUDENT_INIT_SOURCE="teacher"
...
export EXPERIMENT_NAME="driftwam_v4_teacher_onestep_action_response_clean50_seed42"
...
export OUTPUT_DIR="${OUTPUT_DIR:-/root/autodl-fs/wam/runs/driftwam_v4_teacher_onestep_action_response_clean50_seed42}"
